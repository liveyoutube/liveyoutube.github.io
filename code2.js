...
document.getElementById("publishedat").innerHTML="Published at :"+vdata.items[0].snippet.publishedAt.split("T")[0];
document.getElementById("cname").innerHTML="Published By :"+vdata.items[0].snippet.channelTitle;
